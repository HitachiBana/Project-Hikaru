...
@section('konten')
<!-- START FORM -->
    <form action='{{ url('project/'.$data->project_id) }}' method='post'>
    @csrf
    @method('PUT')
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='p_name' value="{{ $data->project_name }}" id="p_name">
                </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="date" class="form-control" name='p_start' value="{{ $data->project_start }}" id="p_start">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="jurusan" class="col-sm-2 col-form-label">Project End</label>
                <div class="col-sm-10">
                    <input type="date" class="form-control" name='p_end' value="{{ $data->project_end }}" id="p_end">
                </div>
            </div>
            <div class="mb-3 row">
